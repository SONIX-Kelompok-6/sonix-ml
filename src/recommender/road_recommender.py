...
road running shoe features. Implements flat data-driven feature mapping and 
set-based masking logic to maintain extremely low cyclomatic complexity.
"""
...
def preprocess_road_input(user_input: Dict[str, Any], 
    ...
    Preserves exact original logic but flattens nested structures using 
    dictionary getters and set intersections.
    ...
    Returns:
        Tuple[List[float], List[int]]: 
            ...
            - A list of indices representing active user preferences.
    """
...
def get_recommendations(user_input: Dict[str, Any], artifacts: Dict[str, Any]) -> List[str]:
    ...
    Args:
        user_input (Dict[str, Any]): Validated user preferences.
        artifacts (Dict[str, Any]): Dictionary of loaded models and configurations.
